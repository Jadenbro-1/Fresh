...
const StartCooking = ({ route, navigation }) => {
  ...
  const renderImage = () => {
    if (step === 1) {
      return <Image source={require('../assets/gatheringredients.png')} style={styles.stepImage} />;
    } else if (step > 1 && step <= recipe.instructions.split('\n').length + 1) {
      return <Image source={require('../assets/begincooking.png')} style={styles.stepImage} />;
    } else if (step === recipe.instructions.split('\n').length + 2) {
      return <Image source={require('../assets/enjoy.png')} style={styles.stepImage} />;
    } else {
      return <Image source={require('../assets/review.png')} style={styles.stepImage} />;
    }
  };

  return (
    <ImageBackground source={require('../assets/cookbackground.jpg')} style={styles.background}>
      <View style={styles.container}>
        ...
        >
          <Image
            source={
              step <= recipe.instructions.split('\n').length + 2
                ? require('../assets/goforward.png')
                : require('../assets/gobackw.png')
            }
